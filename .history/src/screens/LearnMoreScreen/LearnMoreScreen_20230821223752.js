...
const LearnMoreScreen = () => {
  return (
    <View className=" bg-[#cce6ff]">
      <ScrollView className="m-7" showsVerticalScrollIndicator={false}>
        <Text className="text-black text-xl mb-2 font-bold text-center">
          About HireMate
        </Text>
        ...
        <Text className="text-black text-xl mb-4 ">
          One of the key features of Hiremate is the eWallet system, which
          allows users to securely and efficiently manage their finances.
          Freelancers can easily receive payments for their work and withdraw
          their earnings to their bank accounts or other payment methods.
          Clients can deposit funds into their accounts and release payments to
          freelancers once the work is completed to their satisfaction
        </Text>
        <Text className="text-black text-xl mb-4 ">
