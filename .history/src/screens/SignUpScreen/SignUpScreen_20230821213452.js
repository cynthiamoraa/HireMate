...
const PostData = async () => {
  try {
    ...
    const response = await fetch('https://hiremate-hnjv.onrender.com/signup', {
      method: 'post',
      headers: {
    ...
    <ScrollView showsVerticalScrollIndicator={false}>
      <View className="bg-white h-screen">
        ...
        <CustomInput
          ...
          value={username}
          setValue={setUsername} bgColor="#cce6ff"
        />
        <CustomInput
        placeholder="Email"
        value={email}
        setValue={setEmail} bgColor="#cce6ff" />

        <CustomInput
        placeholder="Phone number"
         value={phone}
          setValue={setPhone} bgColor="#cce6ff"
         />
        <CustomInput
          placeholder="Password"
          value={password}
          setValue={setPassword}
          secureTextEntry={true} bgColor="#cce6ff"
        />
        {/* <CustomInput
