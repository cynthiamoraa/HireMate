    ...
    <View className="">
      {userData && (
        <View>
          ...
          <Text className="text-lg p-1">Title: {userData.title}</Text>
          <Text className="text-lg p-1">Username: {userData.postedBy.username}</Text>
          <Text className="text-lg p-1">Email: {userData.postedBy.email}</Text>
