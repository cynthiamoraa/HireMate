    ...
    <View>
      {userData && (
        <View>
          ...
          <Text className="text-lg p-2">Title: {userData.title}</Text>
          <Text className="text-lg p-2">Username: {userData.postedBy.username}</Text>
          <Text className="text-lg p-2">Email: {userData.postedBy.email}</Text>
