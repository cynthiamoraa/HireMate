    ...
    <View>
      {userData && (
        <View>
          ...
          <Text className="">Title: {userData.title}</Text>
          <Text className="">Username: {userData.postedBy.username}</Text>
          <Text className="">Email: {userData.postedBy.email}</Text>
          ...
          {userData.apply.map((applicant, index) => (
            <View key={index} className="p-3">
              <Text className="">Username: {applicant.username}</Text>
              <Text className="">Email: {applicant.email}</Text>
            </View>
          ))}
        </View>
      )}
