    ...
    <View>
      {userData && (
        <View>
          ...
          <Text className="text-lg p-3">Title: {userData.title}</Text>
          <Text className="text-lg p-3">Username: {userData.postedBy.username}</Text>
          <Text className="text-lg p-3">Email: {userData.postedBy.email}</Text>
