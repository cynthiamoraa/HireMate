    ...
    <View>
      {userData && (
        <View>
          ...
          <Text className="text-l">Title: {userData.title}</Text>
          <Text className="text-l">Username: {userData.postedBy.username}</Text>
          <Text className="text-l">Email: {userData.postedBy.email}</Text>
          ...
          {userData.apply.map((applicant, index) => (
            <View key={index} className="p-3">
              <Text className="text-l">Username: {applicant.username}</Text>
              <Text className="text-l">Email: {applicant.email}</Text>
            </View>
          ))}
        </View>
      )}
