    ...
    <View>
      {userData && (
        <View>
          ...
          <Text className="text-md">Title: {userData.title}</Text>
          <Text className="text-md">Username: {userData.postedBy.username}</Text>
          <Text className="text-md">Email: {userData.postedBy.email}</Text>
          ...
          {userData.apply.map((applicant, index) => (
            <View key={index} className="p-3">
              <Text className="text-md">Username: {applicant.username}</Text>
              <Text className="text-md">Email: {applicant.email}</Text>
            </View>
          ))}
        </View>
      )}
