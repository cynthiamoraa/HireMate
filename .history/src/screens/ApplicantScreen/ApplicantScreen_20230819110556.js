    ...
    <View>
      {userData && (
        <View>
          ...
          <Text className="text">Title: {userData.title}</Text>
          <Text className="text">Username: {userData.postedBy.username}</Text>
          <Text className="text">Email: {userData.postedBy.email}</Text>
          ...
          {userData.apply.map((applicant, index) => (
            <View key={index} className="p-3">
              <Text className="text">Username: {applicant.username}</Text>
              <Text className="text">Email: {applicant.email}</Text>
            </View>
          ))}
        </View>
      )}
