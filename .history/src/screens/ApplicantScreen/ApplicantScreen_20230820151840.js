...
const review = async (applicantId,amount) => {
  console.log('review for applicant:', applicantId);
  navigation.navigate('Review', {applicantId},{amount}); // Pass the applicantId as a parameter
};
       ...
       body: JSON.stringify({
         ...
         if (response.status === 200) {
           ...
           openMail(applicantEmail);
             review(applicantId, userData.amount,);
