    ...
    <View>
      {userData && (
        <View>
          ...
          <Text className="text-lg">Title: {userData.title}</Text>
          <Text className="text-lg">Username: {userData.postedBy.username}</Text>
          <Text className="text-lg">Email: {userData.postedBy.email}</Text>
