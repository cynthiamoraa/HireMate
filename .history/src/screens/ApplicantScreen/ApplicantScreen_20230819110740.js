    ...
    <View className="m-2">
      {userData && (
        <View>
          ...
          <Text className="text-lg p-1 ml">Title: {userData.title}</Text>
          <Text className="text-lg p-1 ml">Username: {userData.postedBy.username}</Text>
          <Text className="text-lg p-1 ml">Email: {userData.postedBy.email}</Text>
