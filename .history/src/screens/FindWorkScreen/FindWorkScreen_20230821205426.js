      ...
      {data.map(item => {
        return (
          <View key={item._id} className="border mt-10 bg-slate-200 rounded-2xl">
            <Text className="pl-2 font-bold mt-5 text-xl t">{item.title}</Text>
            <Text className=" mt-3 pl-4 text-lg t">{item.body}</Text>
            <Text className=" mt-3 pl-4 text-md t">{item.amount} ksh</Text>
            <Text className=" mt-3 pl-4 text-md t">
              posted by:{' '}
