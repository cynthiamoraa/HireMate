      ...
      {data.map(item => {
        return (
          <View key={item._id} className="border mt-10 bg-slate-200 rounded-2xl">
            <Text className="pl-2 font-bold mt-5 text-xl text">{item.title}</Text>
            <Text className=" mt-3 pl-4 text-lg text">{item.body}</Text>
            <Text className=" mt-3 pl-4 text-md text">{item.amount} ksh</Text>
            <Text className=" mt-3 pl-4 text-md text">
              posted by:{' '}
