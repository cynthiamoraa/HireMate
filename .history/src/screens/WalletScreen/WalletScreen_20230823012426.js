  ...
  return (
    <SafeAreaView>
      ...
      <View>
        ...
        <View className="flex-row mt-5 mx-3">
  {withdrawn && (
    <>
      <Text className="mr-12 font-bold text-xl">{generateRandomKey()}</Text>
      <Text className="ml-12 text-lg">{route.params.withdraw} ksh</Text>
    </>
  )}
</View>
<View className="flex-row mt-5 mx-3">
  {toppedUp && (
    <>
      <Text className="mr-12 font-bold text-xl">{generateRandomKey()}</Text>
      <Text className="ml-12 text-lg">{route.params.topup} ksh</Text>
    </>
  )}
</View>
        </ScrollView>
