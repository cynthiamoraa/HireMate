  ...
  return (
    <SafeAreaView>
      ...
      <View>
        ...
        {data.map(item => {
        return (
          <View key={item._id} className="border flex-row rounded-sm">
            <Text className="pl-2 font-bold mt-5 text-xl">{item.trnx_id}</Text>
            <Text className=" mt-3 pl-4 text-lg">{item.amount}</Text>
          </View>
        );}
            )}
      </View>
