...
const sendPayment = async (applicantId) => {
  const route = useRoute();
  try {
     // Get the route object
    const {applicantId, amount} = route.params;

       const {params} = route;
      if (params && params.applicantId,params.amount) {
        console.log( params.applicantId,params.amount);
